...
public class RegisterDAO {
	...
	public void registerCompetition(Register r) throws SQLException {
		final String SQL = "INSERT INTO [MidTermProject].[dbo].[register]([mID], [cID]) VALUES(?, ?)";

		PreparedStatement preState = conn.prepareStatement(SQL);
		preState.setInt(1, r.getmID());
		preState.setInt(2, r.getcID());
